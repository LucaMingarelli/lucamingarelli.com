document.write('<footer class="w3-container w3-padding-8 w3-dark-grey">\
    ...
    <div class="w3-row-padding"id="contact">\
      <div class="w3-third">\
        <h3>CONTACT</h3>\
        <b>mail</b>:<br> lucamingarelli@me.com</br>\
        <b>professional mail</b>:<br> luca.mingarelli@ecb.europa.eu</p>\
        <!--<p><b>tel</b>:+44 (0) 744987827</p>-->\
      </div>\
      <div class="w3-third">\
        <h3>LOCATION</h3>\
      ...
      <div class="w3-third">\
        ...
        <p><a href="https://www.linkedin.com/in/lucamingarelli/">LinkedIn</a></br>\
          ...
          <a href="https://www.buymeacoffee.com/lucamingarelli" target="_blank"><img src="https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png" alt="Buy Me A Coffee" style="height: 14px !important;width: 61px !important;box-shadow: 0px 3px 2px 0px rgba(190, 190, 190, 0.5) !important;-webkit-box-shadow: 0px 3px 2px 0px rgba(190, 190, 190, 0.5) !important;" ></a>\
      </div>\
    </div>\
  </footer> ')
