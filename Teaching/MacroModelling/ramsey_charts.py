...
k_start = (A/(δ+ρ))**2/4
plt.axvline(k_start, color='k', linewidth=1, ymin=0.04)
...
plt.scatter(x=1, y=0, marker='o', color='red', zorder=5)
plt.scatter(x=k_start, y=f(k_start) - (n+δ)*k_start, marker='o', color='red', zorder=5)
plt.tight_layout()
